...
parser.add_argument(
    ...
    type=int,
    required=True,
    help="Number of clients, used to scale data",
)
...
def prepare_dataset(num_client):
    ...
    num_images = len(trainset) // NUM_CLIENTS //num_client
...
def main():
    ...
    trainsets, valsets, _ = prepare_dataset(args.num_client)
